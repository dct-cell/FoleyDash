...
from src.ext.rotary_embeddings import apply_rope
...
class SelfAttention(nn.Module):
    ...
    def pre_attention(
        self, x: torch.Tensor, rot: torch.Tensor | None
...
class MMDitSingleBlock(nn.Module):
    ...
    def pre_attention(
        self, x: torch.Tensor, c: torch.Tensor, rot: torch.Tensor | None
    ):
        # x: BS * N * D
        # cond: BS * D
    ...
    def forward(
        self, x: torch.Tensor, cond: torch.Tensor, rot: torch.Tensor | None
    ) -> torch.Tensor:
        # x: BS * N * D
        # cond: BS * D
