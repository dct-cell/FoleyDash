...
from src.ext.synchformer import Synchformer
...
class FeaturesUtils(nn.Module):
    def __init__(
        self,
        *,
        tod_vae_ckpt: str = None,
        bigvgan_vocoder_ckpt: str = None,
        synchformer_ckpt: str = None,
    ...
    def compile(self):
        ...
        self.decode = torch.compile(self.decode).__get__(self, self.__class__)
        self.vocode = torch.compile(self.vocode).__get__(self, self.__class__)
